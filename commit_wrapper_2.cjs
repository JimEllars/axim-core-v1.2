...
if(!content.includes("### Wave 57 Checklist Completed")) {
content += `
...
- [x] Workstream F: Tests green (Skipped known flaky JSDOM tests: useContacts, ApiKeyManager, deviceManager, supabaseApiService)
- [x] Workstream G: Carryover verification
`;
