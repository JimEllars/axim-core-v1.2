...
- **ApiKeyManager:** Replaced hardcoded dummy strings with cryptographically secure `crypto.getRandomValues` keys for an interim safe-fallback. (Note: True backend issuance still pending).
