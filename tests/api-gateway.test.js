...
describe('apiProxy Healthy Event', () => {
    it('dispatches edge:healthy event on successful HTTP 200 response', async () => {
        vi.resetModules();
        ...
        global.window.addEventListener('edge:healthy', listener);
