/**
 * Shared AXiM Core Legal Constants
 *
 * This module standardizes the legal jurisdictions and statutes across
 * all micro apps (e.g., Demand Letter Generator, Non-Compete).
 * This ensures the AXiM Core can programmatically understand the legal
 * frameworks each app supports.
 */
